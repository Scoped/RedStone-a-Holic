...
public class Block_Torch_BlackStone extends BlockTorchRSaH
{
	...
	protected Block_Torch_BlackStone(int id, boolean isLite)
	{
        ...
        this.setIconTorch("TorchIdle0");
        this.setIconTorchLit("Torch0");
    ...
    if (this.isTorchActive)
    {
        if (flag)
        {
            par1World.setBlock(par2, par3, par4, ModBlocks.BlackStoneTorchIdle.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    ...
    {
        par1World.setBlock(par2, par3, par4, ModBlocks.BlackStoneTorchActive.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    }
    }
    ...
    {
        return ModBlocks.BlackStoneTorchActive.blockID;
    }
    ...
    {
        return par1 == ModBlocks.BlackStoneTorchIdle.blockID || par1 == ModBlocks.BlackStoneTorchActive.blockID;
    }
}