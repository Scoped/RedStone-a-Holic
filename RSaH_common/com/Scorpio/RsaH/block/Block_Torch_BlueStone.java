...
public class Block_Torch_BlueStone extends BlockTorchRSaH
{
    /** Map of ArrayLists of RedstoneAHolicUpdateInfo. Key of map is World. */
    private static Map bluestoneUpdateInfoCache = new HashMap();
    
	protected Block_Torch_BlueStone(int id, boolean isLite)
	{
		super(id, isLite);
        this.isTorchActive = isLite;
        this.setIconTorch("TorchIdle1");
        this.setIconTorchLit("Torch1");
        this.setTickRandomly(true);
        this.setCreativeTab((CreativeTabs)null);
		this.setUnlocalizedName(Strings.BLOCK_TORCH_BLUESTONE_NAME);
	}

	private boolean checkForBurnout(World par1World, int par2, int par3, int par4, boolean par5)
    {
        if (!bluestoneUpdateInfoCache.containsKey(par1World))
        {
        	bluestoneUpdateInfoCache.put(par1World, new ArrayList());
        }

        List list = (List)bluestoneUpdateInfoCache.get(par1World);
    ...
    if (this.isTorchActive)
    {
        if (flag)
        {
            par1World.setBlock(par2, par3, par4, ModBlocks.BlueStoneTorchIdle.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    ...
    {
        par1World.setBlock(par2, par3, par4, ModBlocks.BlueStoneTorchActive.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    }
    }
    ...
    {
        return ModBlocks.BlueStoneTorchActive.blockID;
    }
    ...
    {
        return par1 == ModBlocks.BlueStoneTorchIdle.blockID || par1 == ModBlocks.BlueStoneTorchActive.blockID;
    }
}