...
public class Block_Torch_CyanStone extends BlockTorchRSaH
{
	...
	protected Block_Torch_CyanStone(int id, boolean isLite)
	{
        ...
        this.setIconTorch("TorchIdle3");
        this.setIconTorchLit("Torch3");
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        if (this.isTorchActive)
        {
            ...
            if (l == 1)
            {
                par1World.spawnParticle("reddust", d0 - d4, d1 + d3, d2, -1.0D, 0.7D, 1.0D);
            }
            else if (l == 2)
            {
                par1World.spawnParticle("reddust", d0 + d4, d1 + d3, d2, -1.0D, 0.7D, 1.0D);
            ...
            {
                par1World.spawnParticle("reddust", d0, d1 + d3, d2 - d4, -1.0D, 0.7D, 1.0D);
            }
            else if (l == 4)
            {
                par1World.spawnParticle("reddust", d0, d1 + d3, d2 + d4, -1.0D, 0.7D, 1.0D);
            ...
            {
                par1World.spawnParticle("reddust", d0, d1, d2, -1.0D, 0.7D, 1.0D);
            }
        }
    }
