...
public class Block_Torch_GlowStone extends BlockTorchRSaH
{
    /** Map of ArrayLists of RedstoneAHolicUpdateInfo. Key of map is World. */
    private static Map glowstoneUpdateInfoCache = new HashMap();
    
	protected Block_Torch_GlowStone(int id, boolean isLite)
	{
		super(id, isLite);
        this.isTorchActive = isLite;
        this.setIconTorch("TorchIdle16");
        this.setIconTorchLit("Torch16");
        this.setTickRandomly(true);
        this.setCreativeTab((CreativeTabs)null);
		this.setUnlocalizedName(Strings.BLOCK_TORCH_GLOWSTONE_NAME);
	}

	private boolean checkForBurnout(World par1World, int par2, int par3, int par4, boolean par5)
    {
        if (!glowstoneUpdateInfoCache.containsKey(par1World))
        {
        	glowstoneUpdateInfoCache.put(par1World, new ArrayList());
        }

        List list = (List)glowstoneUpdateInfoCache.get(par1World);
    ...
    if (this.isTorchActive)
    {
        if (flag)
        {
            par1World.setBlock(par2, par3, par4, ModBlocks.GlowStoneTorchIdle.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    ...
    {
        par1World.setBlock(par2, par3, par4, ModBlocks.GlowStoneTorchActive.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    }
    }
    ...
    {
        return ModBlocks.GlowStoneTorchActive.blockID;
    }
    ...
    {
        return par1 == ModBlocks.GlowStoneTorchIdle.blockID || par1 == ModBlocks.GlowStoneTorchActive.blockID;
    }
}