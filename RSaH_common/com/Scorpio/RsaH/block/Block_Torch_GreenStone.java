...
public class Block_Torch_GreenStone extends BlockTorchRSaH
{
    /** Map of ArrayLists of RedstoneAHolicUpdateInfo. Key of map is World. */
    private static Map greenstoneUpdateInfoCache = new HashMap();
    
	protected Block_Torch_GreenStone(int id, boolean isLite)
	{
		super(id, isLite);
        this.isTorchActive = isLite;
        this.setIconTorch("TorchIdle6");
        this.setIconTorchLit("Torch6");
        this.setTickRandomly(true);
        this.setCreativeTab((CreativeTabs)null);
		this.setUnlocalizedName(Strings.BLOCK_TORCH_GREENSTONE_NAME);
	}

	private boolean checkForBurnout(World par1World, int par2, int par3, int par4, boolean par5)
    {
        if (!greenstoneUpdateInfoCache.containsKey(par1World))
        {
        	greenstoneUpdateInfoCache.put(par1World, new ArrayList());
        }

        List list = (List)greenstoneUpdateInfoCache.get(par1World);
    ...
    if (this.isTorchActive)
    {
        if (flag)
        {
            par1World.setBlock(par2, par3, par4, ModBlocks.GreenStoneTorchIdle.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    ...
    {
        par1World.setBlock(par2, par3, par4, ModBlocks.GreenStoneTorchActive.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    }
    }
    ...
    {
        return ModBlocks.GreenStoneTorchActive.blockID;
    }
    ...
    {
        return par1 == ModBlocks.GreenStoneTorchIdle.blockID || par1 == ModBlocks.GreenStoneTorchActive.blockID;
    }
}