...
public class Block_Torch_LightGrayStone extends BlockTorchRSaH
{
    /** Map of ArrayLists of RedstoneAHolicUpdateInfo. Key of map is World. */
    private static Map lightgraystoneUpdateInfoCache = new HashMap();
    
	protected Block_Torch_LightGrayStone(int id, boolean isLite)
	{
		super(id, isLite);
        this.isTorchActive = isLite;
        this.setIconTorch("TorchIdle8");
        this.setIconTorchLit("Torch8");
    ...
    {
        if (!lightgraystoneUpdateInfoCache.containsKey(par1World))
        {
        	lightgraystoneUpdateInfoCache.put(par1World, new ArrayList());
        }

        List list = (List)lightgraystoneUpdateInfoCache.get(par1World);
    ...
    if (this.isTorchActive)
    {
        if (flag)
        {
            par1World.setBlock(par2, par3, par4, ModBlocks.LightGrayStoneTorchIdle.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    ...
    {
        par1World.setBlock(par2, par3, par4, ModBlocks.LightGrayStoneTorchActive.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    }
    }
    ...
    {
        return ModBlocks.LightGrayStoneTorchActive.blockID;
    }
    ...
    {
        return par1 == ModBlocks.LightGrayStoneTorchIdle.blockID || par1 == ModBlocks.LightGrayStoneTorchActive.blockID;
    }
}
