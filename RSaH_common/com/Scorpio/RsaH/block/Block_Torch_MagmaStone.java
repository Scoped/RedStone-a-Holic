...
public class Block_Torch_MagmaStone extends BlockTorchRSaH
{
    /** Map of ArrayLists of RedstoneAHolicUpdateInfo. Key of map is World. */
    private static Map magmastoneUpdateInfoCache = new HashMap();
    
	protected Block_Torch_MagmaStone(int id, boolean isLite)
	{
		super(id, isLite);
        this.isTorchActive = isLite;
        this.setIconTorch("TorchIdle15");
        this.setIconTorchLit("Torch15");
        this.setTickRandomly(true);
        this.setCreativeTab((CreativeTabs)null);
		this.setUnlocalizedName(Strings.BLOCK_TORCH_MAGMASTONE_NAME);
	}

	private boolean checkForBurnout(World par1World, int par2, int par3, int par4, boolean par5)
    {
        if (!magmastoneUpdateInfoCache.containsKey(par1World))
        {
        	magmastoneUpdateInfoCache.put(par1World, new ArrayList());
        }

        List list = (List)magmastoneUpdateInfoCache.get(par1World);
    ...
    if (this.isTorchActive)
    {
        if (flag)
        {
            par1World.setBlock(par2, par3, par4, ModBlocks.MagmaStoneTorchIdle.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    ...
    {
        par1World.setBlock(par2, par3, par4, ModBlocks.MagmaStoneTorchActive.blockID, par1World.getBlockMetadata(par2, par3, par4), 3);
    }
    }
    ...
    {
        return ModBlocks.MagmaStoneTorchActive.blockID;
    }
    ...
    {
        return par1 == ModBlocks.MagmaStoneTorchIdle.blockID || par1 == ModBlocks.MagmaStoneTorchActive.blockID;
    }
}