...
public class Block_Wire_BlackStone extends BlockWireRSaH
{
    
	public Block_Wire_BlackStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_BLACKSTONE_NAME);
		this.setIconCross("BlackStoneDust_Cross");
		this.setIconCrossOverlay("BlackStoneDust_Cross_Overlay");
		this.setIconLine("BlackStoneDust_Line");
		this.setIconLineOverlay("BlackStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_BlackStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.BlackStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
        ...
        /*else if (!ModBlocks.BlackStoneRepeaterIdle.func_94487_f(i1))
        {
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.BlackStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPoweredOrRepeater(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            if (i1 == Block.BlackStoneRepeaterActive.blockID)
            {
                int j1 = par0IBlockAccess.getBlockMetadata(par1, par2, par3);
                return par4 == (j1 & 3);
            }
