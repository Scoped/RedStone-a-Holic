...
public class Block_Wire_BrownStone extends BlockWireRSaH
{
    
	public Block_Wire_BrownStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_BROWNSTONE_NAME);
		this.setIconCross("BrownStoneDust_Cross");
		this.setIconCrossOverlay("BrownStoneDust_Cross_Overlay");
		this.setIconLine("BrownStoneDust_Line");
		this.setIconLineOverlay("BrownStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_BrownStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.BrownStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.BrownStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPoweredOrRepeater(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            if (i1 == Block.BrownStoneRepeaterActive.blockID)
            {
                int j1 = par0IBlockAccess.getBlockMetadata(par1, par2, par3);
                return par4 == (j1 & 3);
            }
