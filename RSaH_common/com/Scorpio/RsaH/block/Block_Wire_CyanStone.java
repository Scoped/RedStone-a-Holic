...
public class Block_Wire_CyanStone extends BlockWireRSaH
{
    
	public Block_Wire_CyanStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_CYANSTONE_NAME);
		this.setIconCross("CyanStoneDust_Cross");
		this.setIconCrossOverlay("CyanStoneDust_Cross_Overlay");
		this.setIconLine("CyanStoneDust_Line");
		this.setIconLineOverlay("CyanStoneDust_Line_Overlay");
	}
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (l > 0)
        {
            ...
            float f2 = f * f * 3.0F - 1.0F - -1.0F;
            float f3 = f * f * -1.0F - -1.0F - -1.0F;
    ...
    {
        return ModItems.Dust_CyanStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.CyanStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.CyanStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
