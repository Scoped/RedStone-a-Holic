...
public class Block_Wire_GlowStone extends BlockWireRSaH
{
    
	public Block_Wire_GlowStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_GLOWSTONE_NAME);
		this.setIconCross("GlowStoneDust_Cross");
		this.setIconCrossOverlay("GlowStoneDust_Cross_Overlay");
		this.setIconLine("GlowStoneDust_Line");
		this.setIconLineOverlay("GlowStoneDust_Line_Overlay");
	}
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.GlowStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.GlowStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    {
        return ModItems.Dust_GlowStone.itemID;
    }
