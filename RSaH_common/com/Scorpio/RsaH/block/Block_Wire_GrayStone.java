...
public class Block_Wire_GrayStone extends BlockWireRSaH
{
    
	public Block_Wire_GrayStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_GRAYSTONE_NAME);
		this.setIconCross("GrayStoneDust_Cross");
		this.setIconCrossOverlay("GrayStoneDust_Cross_Overlay");
		this.setIconLine("GrayStoneDust_Line");
		this.setIconLineOverlay("GrayStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_GrayStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.GrayStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.GrayStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
