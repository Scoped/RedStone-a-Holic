...
public class Block_Wire_GreenStone extends BlockWireRSaH
{
    
	public Block_Wire_GreenStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_GREENSTONE_NAME);
		this.setIconCross("GreenStoneDust_Cross");
		this.setIconCrossOverlay("GreenStoneDust_Cross_Overlay");
		this.setIconLine("GreenStoneDust_Line");
		this.setIconLineOverlay("GreenStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_GreenStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.GreenStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.GreenStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
