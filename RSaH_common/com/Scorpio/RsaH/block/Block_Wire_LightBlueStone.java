...
public class Block_Wire_LightBlueStone extends BlockWireRSaH
{
    
	public Block_Wire_LightBlueStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_LIGHTBLUESTONE_NAME);
		this.setIconCross("LightBlueStoneDust_Cross");
		this.setIconCrossOverlay("LightBlueStoneDust_Cross_Overlay");
		this.setIconLine("LightBlueStoneDust_Line");
		this.setIconLineOverlay("LightBlueStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_LightBlueStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.LightBlueStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.LightBlueStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
