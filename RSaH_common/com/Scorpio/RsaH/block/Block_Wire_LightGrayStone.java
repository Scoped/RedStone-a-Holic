...
public class Block_Wire_LightGrayStone extends BlockWireRSaH
{
    
	public Block_Wire_LightGrayStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_LIGHTGRAYSTONE_NAME);
		this.setIconCross("LightGrayStoneDust_Cross");
		this.setIconCrossOverlay("LightGrayStoneDust_Cross_Overlay");
		this.setIconLine("LightGrayStoneDust_Line");
		this.setIconLineOverlay("LightGrayStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_LightGrayStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.LightGrayStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.LightGrayStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
