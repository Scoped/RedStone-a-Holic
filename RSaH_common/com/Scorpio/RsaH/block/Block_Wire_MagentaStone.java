...
public class Block_Wire_MagentaStone extends BlockWireRSaH
{
    
	public Block_Wire_MagentaStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_MAGENTASTONE_NAME);
		this.setIconCross("MagentaStoneDust_Cross");
		this.setIconCrossOverlay("MagentaStoneDust_Cross_Overlay");
		this.setIconLine("MagentaStoneDust_Line");
		this.setIconLineOverlay("MagentaStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_MagentaStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.MagentaStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.MagentaStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
