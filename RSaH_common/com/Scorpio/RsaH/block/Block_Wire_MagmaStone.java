...
public class Block_Wire_MagmaStone extends BlockWireRSaH
{
    
	public Block_Wire_MagmaStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_MAGMASTONE_NAME);
		this.setIconCross("MagmaStoneDust_Cross");
		this.setIconCrossOverlay("MagmaStoneDust_Cross_Overlay");
		this.setIconLine("MagmaStoneDust_Line");
		this.setIconLineOverlay("MagmaStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_MagmaStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.MagmaStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.MagmaStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
