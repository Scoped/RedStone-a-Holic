...
public class Block_Wire_OrangeStone extends BlockWireRSaH
{
    
	public Block_Wire_OrangeStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_ORANGESTONE_NAME);
		this.setIconCross("OrangeStoneDust_Cross");
		this.setIconCrossOverlay("OrangeStoneDust_Cross_Overlay");
		this.setIconLine("OrangeStoneDust_Line");
		this.setIconLineOverlay("OrangeStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_OrangeStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.OrangeStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.OrangeStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
