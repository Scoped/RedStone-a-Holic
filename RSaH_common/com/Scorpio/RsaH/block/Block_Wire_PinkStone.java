...
public class Block_Wire_PinkStone extends BlockWireRSaH
{
    
	public Block_Wire_PinkStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_PINKSTONE_NAME);
		this.setIconCross("PinkStoneDust_Cross");
		this.setIconCrossOverlay("PinkStoneDust_Cross_Overlay");
		this.setIconLine("PinkStoneDust_Line");
		this.setIconLineOverlay("PinkStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_PinkStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.PinkStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.PinkStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
