...
public class Block_Wire_PurpleStone extends BlockWireRSaH
{
    
	public Block_Wire_PurpleStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_PURPLESTONE_NAME);
		this.setIconCross("PurpleStoneDust_Cross");
		this.setIconCrossOverlay("PurpleStoneDust_Cross_Overlay");
		this.setIconLine("PurpleStoneDust_Line");
		this.setIconLineOverlay("PurpleStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_PurpleStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.PurpleStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.PurpleStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
