...
public class Block_Wire_WhiteStone extends BlockWireRSaH
{
    
	public Block_Wire_WhiteStone(int id)
	{
		super(id);
		this.setUnlocalizedName(Strings.BLOCK_WIRE_WHITESTONE_NAME);
		this.setIconCross("WhiteStoneDust_Cross");
		this.setIconCrossOverlay("WhiteStoneDust_Cross_Overlay");
		this.setIconLine("WhiteStoneDust_Line");
		this.setIconLineOverlay("WhiteStoneDust_Line_Overlay");
	}
    ...
    {
        return ModItems.Dust_WhiteStone.itemID;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.WhiteStoneWireBlock.blockID)
        {
            return false;
        }
        else if (i1 == 0)
    ...
    public static boolean isPowerProviderOrTorch(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        if (i1 != ModBlocks.WhiteStoneTorchActive.blockID)
        {
            return false;
        }
        else if (i1 == 0)
