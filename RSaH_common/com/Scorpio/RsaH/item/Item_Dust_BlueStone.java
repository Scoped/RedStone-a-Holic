...
public class Item_Dust_BlueStone extends ItemRSaH
{
	...
	public Item_Dust_BlueStone(int id)
	{
		...
		this.setUnlocalizedName(Strings.ITEM_DUST_BLUESTONE_NAME);
	}
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        {
            if (ModBlocks.BlueStoneWireBlock.canPlaceBlockAt(par3World, par4, par5, par6))
            {
                --par1ItemStack.stackSize;
                par3World.setBlock(par4, par5, par6, ModBlocks.BlueStoneWireBlock.blockID);
            }
